  ...
  render() {
    ...
    return (
      ...
      >
            ...
            dangerouslySetInnerHTML={{
              __html: `
                ...
                .logo-text-inner {
                  stroke-dasharray: 800;
                  stroke-dashoffset: 800;
                  animation: textDraw 3.5s ease forwards 0.5s;
                }
                .logo-text-signature {
                  stroke-dasharray: 800;
                  stroke-dashoffset: 800;
                  animation: textDraw 4.5s ease forwards 1s;
                }
              `,
            }}
          />
        ...
        {/* Inner Initials S and B */}
        <text
          x="200"
          y="110"
          className="logo-text-inner"
          fill="none"
          stroke={theme.body}
          strokeWidth="2.5"
        ...
        {/* Cursive / Elegant Signature text below */}
        <text
          x="220"
          y="265"
          className="logo-text-signature"
          fill="none"
          stroke={theme.body}
          strokeWidth="2"
